...
public class MoimController {
    ...
    public MoimDetailListResponse getMoimDetailInfo(@RequestParam(name = "moim_id") @NotNull Long moim_id)
    ...
    public Response getMoimInfoByDeepLink(@RequestParam(name = "encryptInfo") @NotNull String encryptInfo)
            throws Exception {
